...
class GeminiClient {
     ...
     */
    async generateResponse(messages, availableTools, systemPrompt) {
        try {
     ...
     */
    async generateFollowUpResponse(messages, toolCallResults, systemPrompt) {
        try {
     ...
     * Create function declarations for tool calling
     */
    createFunctionDeclarations(tools) {
